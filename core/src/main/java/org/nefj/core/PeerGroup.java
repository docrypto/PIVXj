...
public class PeerGroup implements TransactionBroadcaster {
     ...
     * FP rate is chosen for performance rather than privacy. If a future version of nefj fixes the known
     ...
     * {@link org.nefj.core.listeners.PeerConnectionEventListener} and use the onPeerConnected/onPeerDisconnected methods.
     */
     ...
     *         Use {@link org.nefj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link org.nefj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link org.nefj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link org.nefj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * {@link org.nefj.core.TransactionBroadcast#future()} method will be completed. If anything goes
     ...
     *
     * <p>The returned {@link org.nefj.core.TransactionBroadcast} object can be used to get progress feedback,
     ...
     * times are available via {@link org.nefj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link org.nefj.core.Peer#ping()}.
     */
     ...
     * and easy way for a user to upgrade a nefj based app running in SPV mode to fully validating security.
     */
