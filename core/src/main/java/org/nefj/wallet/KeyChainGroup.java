...
/**
 * <p>A KeyChainGroup is used by the {@link org.nefj.wallet.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws org.nefj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link org.nefj.crypto.KeyCrypterScrypt}.
     *
     * @throws org.nefj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
